...
export type GetSharedListQuery = Omit<PaginatedQuery, "query">;
export type GetSharedGroupQuery = PaginatedQuery;
...
export function createSharedResource(request: RequestFn) {
  return {
    ...
    getSharedList: (listId: string, query?: GetSharedListQuery) =>
    ...
    getSharedGroup: (groupId: string, query?: GetSharedGroupQuery) =>
